# IDFL PEP 0008 Styleguide

## Table of Contents
  1. [Introduction](#introduction)
  1. [A Foolish Consistency is the Hobgoblin of Little Minds](#a-foolish-consistency-is-the-hobgoblin-of-little-minds)
  1. [Code lay-out](#code-lay-out)
  1. [Imports](#imports)
  1. [String Quotes](#string-quotes)
  1. [Whitespace in Expressions and Statements](#whitespace-in-expressions-and-statements)
  1. [Other Recommendations](#other-recommendations)
  1. [Comments](#comments)
  1. [Version Bookkeeping](#version-bookkeeping)
  1. [Naming Conventions](#naming-conventions)
  1. [Public and Internal Interfaces](#public-and-internal-interfaces)
...
1. Surround top-level function and class definitions with two blank
lines.

2. Method definitions inside a class are surrounded by a single blank
line.
...
Use single quote strings over double quote, this is to keep code consistent
with legacy system, and because html strings generally contain more double
quotes than single quotes. When a string contains single or double quote
...
- All single character variables and the following variable names are prohibited
  as they conflict with debugging tool commands and cause many headaches:
  * 'il'
  * 'pp'
  * 'run'
  * 'disable'
...
This document has been placed in the public domain. See [PEP 0008](https://www.python.org/dev/peps/pep-0008/) for source and up to date version of PEP 0008 style guide.
